import re,platform,time,cv2
import numpy as np

from dcam560.Vzense_enums_560 import *
from dcam560.Vzense_types_560 import *
...
class VzenseTofCam():
    ...
    def __init__(self):
        if platform.system() == 'Linux':
            libpath = "/home/rosnuc/Vzense_SDK_Linux/Ubuntu18.04/Lib/libvzense_api.so"
            self.ps_cam_lib = cdll.LoadLibrary(libpath)
        elif platform.system() == 'Windows':          
            libpath = "C:\\Users\\schorrl\\camera\\Lib\\vzense_api.dll"
            self.ps_cam_lib = cdll.LoadLibrary(libpath)    
        else:
